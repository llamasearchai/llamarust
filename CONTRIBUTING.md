# Contributing to LlamaRust

Thank you for your interest in contributing to LlamaRust! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaRust:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamarust.git
   cd llamarust
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamarust.git
   ```
...
By contributing to LlamaRust, you agree that your contributions will be licensed under the project's MIT License.
